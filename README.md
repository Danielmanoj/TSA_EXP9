...
# Update these column names based on the actual columns in your file
date_column = 'Date'  
target_variable = 'Atmospheric_Composition_O2'  
...
```
### OUTPUT:
![image](https://github.com/user-attachments/assets/375131de-83c5-4404-b91f-c2e729f624d8)
